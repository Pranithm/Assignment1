    ...
    class Program
    {
        ...
        */
        ...
        private static string RemoveVowels(string s)
        {
            try
            {
                ...
                // defining an empty string to store the final output;
                String final_string = "";
                // defining the string with vowels 
                string v = "aeiouAEIOU";
                // iterating through each char of input string
                for (int i = 0; i < s.Length; i++)
                {
                    // concatinating the char with output string if the char is not in vowels list
                    if (!v.Contains(s[i]))
                        final_string += s[i];
                }
                // returns output
       ...
       */
        ...
        private static bool ArrayStringsAreEqual(string[] bulls_string1, string[] bulls_string2)
        {
            ...
            {
                // write your code here.
                // converting the input string array to single string using join method
                string s1 = string.Join("", bulls_string1);
                // converting the input string array to single string using join method
                string s2 = string.Join("", bulls_string2);
                // condition to check whether the two converted strings are equal or not
                if(s1==s2) {
        ...
        */
        ...
        private static int SumOfUnique(int[] bull_bucks)
        {
            ...
            {
                // write your code here
                // defining the result integer to store the result
                int result = 0;

                // defining the dictionary to store key as number and repeated count as value
                Dictionary<int, int> dict =
                       new Dictionary<int, int>();
                // iterating through each input integer array to store key values
                for(int i=0;i<bull_bucks.Length;i++)
                {
                    // if key repeats then incrementing the count of its value
                    if (dict.ContainsKey(bull_bucks[i]))
                        dict[bull_bucks[i]] += 1;
                    else
                        // if key is not in the dictionary. create key with value 1
                        dict.Add(bull_bucks[i], 1);
                }

                // iterating through each key to add keys who's value is 1
        ...
        */
        ...
        private static int DiagonalSum(int[,] bulls_grid)
        {
            try
            {
                // write your code here.
                int total = 0;
                // dimensions n*n of the matrix 
                int size = bulls_grid.GetLength(0);
                // iterating through the size of the matrix size 
                for (int i=0;i<size;i++)
                {
                    // adding the left diagonal and right digonal elements
                    total += bulls_grid[i, i];
                    total += bulls_grid[i, size - i-1];
                }
                // checking the size of the matrix
                if (size%2==0)
                       return total;
                // subtracting repeated values for even square matrix
                int repeated = bulls_grid[size / 2, size / 2];
        ...
        */
        ...
        private static string RestoreString(string bulls_string, int[] indices)
        {
            try
            {
                ...
                // iterating through the input indices
                for( int i=0;i<indices.Length;i++)
                {
                    // replaces the existing character with new character and converting it into string
                    s=s.Remove(indices[i],1).Insert(indices[i], bulls_string[i].ToString());
                }
                // replacing the empty character with '*'
        ...
        */
        ...
        private static string ReversePrefix(string bulls_string6, char ch)
        {
            try
            {
                ...
                // defining the ind for index of first occurance of char ch
                int ind = 0;

                //  iterating through the input bulls_string6 
                ...
                // reversing the string from first occurance ch
                for (int i=ind;i>=0;i--)
                {
                    prefix_string += bulls_string6[i];
                }
                //iterating through input and adding all other chars of input string
...
/* 
    self reflection
    learnt how to use dictionaries
    learnt how to use lists effeciently
    syntax of c#
    research about pre-defined functions
    gone through official microsoft c# documentation
    Array handling
